...
const Card = (props) => {
    return (
        <div className="pt-24 px-16 pb-32 bg-gray-50 border-2 mb-16" style={{ width: '49%' }}>
            <img src={props.src} alt={props.alt} className='w-16 mb-6' />
            <h2 className={'text-3xl mb-2 ' + props.h2w }>{props.title}</h2>
...
const About = () => {
    ...
    return (
        <div>
            ...
            <section className="hidden container mx-auto xl:flex flex-row flex-wrap justify-between max-w-7xl mb-24">
                <Card
                    src='./Icon1.png'
                    alt='Due Diligence'
                    title='Due Diligence'
