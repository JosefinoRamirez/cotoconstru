...
const Footer = (props) => {
    ...
    return (
      <footer className="text-white" style={{ backgroundColor: '#000000' }}>
        <section style={{ backgroundColor: '#132523' }} className={"pb-28 flex flex-col items-center px-8 md:px-0 " + props.footerForm}>
        ...
        <div className="container m-auto flex flex-col md:flex-row items-start justify-between border-b-black md:border-b-white border-b-2 py-24 px-8 md:px-0 pb-8 md:pb-24">
          ...
          <section className="flex flex-col md:w-96 border-t-white border-t-2 md:border-t-0 pt-8 md:pt-0">
            <h6>Visit Us</h6>
